...
$cvv = multiexplode(array(":", "/", " ", "|"), $message)[3];
  ...
  if (empty($cvv)) {
    ...
    $lista = "$cc|$mes|$ano|$cvv";
     ...
     $sendmes = "https://api.telegram.org/bot$botToken/sendMessage?chat_id=".$chatId."&text=<b>𝑪𝒂𝒓𝒎𝒊𝒏𝒆 𝑪𝑯𝑲 𝑩𝒐𝒕 ♦️️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] CC: ".$listaxz."%0A[ϟ] STATUS: BEING CHECKED,PELASE WAIT.%0A━━━━━━━━━━━━━</b>&reply_to_message_id=".$message_id."&parse_mode=HTML";
...
$time_end = microtime(true);
  ...
  editMessage($chatId, "<b>𝑪𝒂𝒓𝒎𝒊𝒏𝒆 𝑪𝑯𝑲 𝑩𝒐𝒕 ♦️️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] GATE: STRIPE AUTH%0A[ϟ] CC: <code>$listaxz</code>%0A[ϟ] STATUS: $pass%0A[ϟ] RESPONSE: $msg%0A[ϟ] BUG BIN: $isbug%0A$binrs%0A━━━━━━━━━━━━━%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>",$mes_id);
}
